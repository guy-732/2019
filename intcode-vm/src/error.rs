...
{
    #[error("The instruction {0} was not any of [01, 02, 03, 04, 05, 06, 07, 08, 09, 99]")]
    ...
    #[error("The argument mode in opcode {opcode} for argument n°{arg_num} is not recognized (was {arg_mode}, should be 0, 1 or 2)")]
    InvalidArgMode {
        opcode: u16,
        arg_num: u8,
        arg_mode: u8,
